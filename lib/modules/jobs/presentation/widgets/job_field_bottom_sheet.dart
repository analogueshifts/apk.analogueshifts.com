...
class JobFieldBottomSheet extends StatefulWidget {
  const JobFieldBottomSheet({super.key});

  @override
  State<JobFieldBottomSheet> createState() => _JobFieldBottomSheetState();
}

class _JobFieldBottomSheetState extends State<JobFieldBottomSheet> {

  final _search = TextEditingController();

  JobRole? _rolesList;

  List<JobRole> filteredFields = [];
  ...
  void filterSearchResults(String query) {
    ...
    if (query.isNotEmpty) {
      ...
      setState(() {
        filteredFields= [];
        filteredFields.addAll(dummyListData);
      });
      return;
    } else {
      setState(() {
        filteredFields = [];
        filteredFields = roles;
      });
    }
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        TextSemiBold("Job Field", fontSize: 20,),
                        InkWell(
                            onTap: (){
                    ...
                    const Gap(30),
                    filteredFields.isEmpty ? Center(child: Text("No Job Fields!"),) :
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children:
