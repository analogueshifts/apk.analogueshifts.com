...
import 'package:analogue_shifts_mobile/modules/jobs/presentation/widgets/datefield.dart';
...
class _PostAJobScreenState extends State<PostAJobScreen> {
  ...
  validateFirstForm() {
    if (_company == null ||
        ...
        _jobField.text.isEmpty ||
        _qualifiication.text.isEmpty ||
        _location.text.isEmpty ||
        _city.text.isEmpty ||
        _employmentType.text.isEmpty) {
      setState(() {
  ...
  validateSecondForm() {
    if (_applicationDeadline.text.isEmpty ||
        _paymentType.text.isEmpty ||
        _maxAmount.text.isEmpty ||
        _minAMount.text.isEmpty ||
        _currency.text.isEmpty) {
      setState(() {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Center(
                  child: TextSemiBold(
                "To post a job kindly fill in job details below",
                fontSize: 14,
              ...
              InkWell(
                onTap: () async {
                  job.getSavedCompanies(context, 1);
                  Company? results = await showModalBottomSheet(
                      context: context,
                      builder: (context) {
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      TextSemiBold(
                        _company == null ? "Company Name" : _company!.name!,
                        color: isLight
                            ? Color(0xff000000)
                                .withOpacity(_company == null ? 0.40 : 0.9)
                            : AppColors.grey,
                      ),
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      TextSemiBold(
                          _positionTitle.text.isEmpty
                              ? "Job role title"
                              : _positionTitle.text,
                          color: isLight
                              ? Color(0xff000000).withOpacity(
                                  _positionTitle.text.isEmpty ? 0.40 : 0.90)
                              : AppColors.grey),
                      Icon(Icons.keyboard_arrow_down)
                    ],
                  ),
                  ...
                  child: Row(
                    ...
                    children: [
                      TextSemiBold(
                          ...
                          color: isLight
                              ? Color(0xff000000).withOpacity(
                                  _jobField.text.isEmpty ? 0.40 : 0.90)
                              : AppColors.grey),
                      Icon(Icons.keyboard_arrow_down)
                    ],
                  ),
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      TextSemiBold(
                          _qualifiication.text.isEmpty
                              ? "Choose expected qualification"
                              : _qualifiication.text,
                          color: isLight
                              ? Color(0xff000000).withOpacity(
                                  _qualifiication.text.isEmpty ? 0.40 : 0.90)
                              : AppColors.grey),
                      Icon(Icons.keyboard_arrow_down)
                    ],
                  ),
              ...
              InkWell(
                onTap: () async {
                  ...
                  if (result != null &&
                      result.runtimeType.toString().toLowerCase() == "string") {
                    setState(() {
                  ...
                  child: Row(
                    ...
                    children: [
                      TextSemiBold(
                        ...
                        color: isLight
                            ? Color(0xff000000).withOpacity(
                                _location.text.isEmpty ? 0.40 : 0.90)
                            : AppColors.grey,
                      ),
                      Icon(Icons.keyboard_arrow_down)
                    ],
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      TextSemiBold(
                          _employmentType.text == null
                              ? "Select employment type"
                              : _employmentType.text,
                          color: isLight
                              ? Color(0xff000000).withOpacity(
                                  _employmentType.text.isEmpty ? 0.40 : 0.90)
                              : AppColors.grey),
                      Icon(Icons.keyboard_arrow_down)
                    ],
                  ),
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      TextSemiBold(
                        _paymentType.text.isEmpty
                            ? "Select the preferred payment type"
                            : _paymentType.text,
                        color: isLight
                            ? Color(0xff000000).withOpacity(
                                _paymentType.text.isEmpty ? 0.40 : 0.9)
                            : AppColors.grey,
                      ),
                      Icon(Icons.keyboard_arrow_down)
                    ],
                  ...
                  child: Row(
                    ...
                    children: [
                      TextSemiBold(
                          ...
                          color: isLight
                              ? Color(0xff000000).withOpacity(
                                  _currency.text.isEmpty ? 0.40 : 0.90)
                              : AppColors.grey),
                      Icon(Icons.keyboard_arrow_down)
                    ],
                  ),
              ...
              onDateChanged: (date) {
                setState(() {
                  _applicationDeadline.text = date;
                });
              },
            ),
              Gap(30),
            ...
            children: [
              ...
              Text.rich(
                TextSpan(
                  children: [
                    TextSpan(
                      text: 'Tell us about the role (Description):',
                      style: TextStyle(
                        fontWeight: FontWeight.w700,
                        color: isLight ? AppColors.background : AppColors.white,
                      ),
                ...
                decoration: textInputDecoration.copyWith(
                    ...
                    hintStyle: TextStyle(
                        color: Theme.of(context).colorScheme.brightness == Brightness.light
                            ? const Color(0xff000000).withOpacity(0.25)
                            : const Color(0xffFFFFFF).withOpacity(0.4)),
                    hintText: 'Input application Option'),
                validator: (value) {
                  if (value == null) return ("Enter application Option");
                ...
                decoration: textInputDecoration.copyWith(
                    ...
                    hintStyle: TextStyle(
                        color: Theme.of(context).colorScheme.brightness == Brightness.light
                            ? const Color(0xff000000).withOpacity(0.25)
                            : const Color(0xffFFFFFF).withOpacity(0.4)),
                    hintText: 'Input Application url'),
                validator: (value) {
                  if (value == null) return ("Application url");
                      ...
                      AddJobDto(
                        ...
                        baseSalary: BaseSalary(
                          ...
                          value: QuantitativeValue(
                            ...
                            value:
                                "${_minAMount.text} - ${_maxAmount.text}, ${_paymentType.text} ",
                            unitText: _paymentType.text.toUpperCase(),
                          ),
                        ),
                        directApply: 'true',
                        ...
                        jobLocation: JobLocation(
                          ...
                          address: Address(
                            type: "PostalAddress",
                            streetAddress: _city.text,
                            addressRegion: _city.text,
                            addressCountry: _location.text,
                            addressLocality: _city.text,
                          ),
                        ),
                        jobLocationType: 'TELECOMMUTE',
                        validThrough: _applicationDeadline.text,
                        status: '1', //_jobField.text
                        apply: _applicationUrl.text,
                        slug: _positionTitle.text,
                      ),
                      context,
                    );
                  }),
