           ...
           return SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Gap(5),
                    TextSemiBold(
                        'Don’t worry! It occurs. Please enter the email address linked with your account.', color: Theme.of(context).colorScheme.brightness == Brightness.light ? const Color(0xff000000).withOpacity(0.6) : const Color(0xff909090) ,),
                    const Gap(30),
                    Form(
                      key: _formKey,
                      child: TextFormField(
